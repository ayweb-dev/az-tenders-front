...
import { FaCheck, FaTrashAlt, FaEyeSlash  } from "react-icons/fa";
...
const TableBody = ({
  ...
  sortDirection,
  isLoading,
  onMarkAsSeen, // Callback pour marquer comme vu
...
const Table = ({ headers, data, isLoading, loadingTag, onMarkAsSeen, onDelete }) => {
